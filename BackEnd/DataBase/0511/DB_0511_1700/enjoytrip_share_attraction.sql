...
CREATE TABLE `share_attraction` (
  ...
  KEY `fk_share_board_board_no_idx` (`board_no`),
  ...
  CONSTRAINT `fk_share_board_board_no` FOREIGN KEY (`board_no`) REFERENCES `share_board` (`board_no`)
...
-- Dump completed on 2023-05-11 17:33:30
